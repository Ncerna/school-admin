...
import { EvaluationPeriodDetailsDialog } from "./EvaluationPeriodDetailsDialog";
...
{ header: "Estado", accessor: "status", render: (item) => item.status ? <StatusBadge estado={item.status} /> : "—" },
...
export default function EvaluationPeriodPage() {
  ...
  const [viewingItem, setViewingItem] = useState<EvaluationPeriod | null>(null);
